function keyPressActivity(e, week_id, value) {
  if (e.keyCode == 13) {
    ...
    jQuery(".td-activity-" + week_id).append(
      "<div class='font14 wrap-fontawesome activity-" +
        week_id +
        "-" +
        code +
        "'><i class='fas fa-chevron-circle-right color-orange fa-2x'></i> " +
        value +
        "</div>"
    );
    jQuery(".td-activity-modal-" + week_id).append(
      "<div class='d-flex align-items-center form-group mb-1 activity-" +
        week_id +
        "-" +
        code +
        "'><a href='javascript::void(0);' class='color-orange font20 mr-1' onclick=\"removeInput('activity-" +
        week_id +
        "-" +
        code +
        "')\"><i class='fas fa-minus-circle fas-16'></i></a><input type='text' value='" +
        value +
        "' class='input2 bg-grey-light border-none'></div>"
    );
  }
}
...
function keyPressContent(e, week_id, value) {
  if (e.keyCode == 13) {
    ...
    jQuery(".td-content-" + week_id).append(
      "<div class='font14 wrap-fontawesome content-" +
        week_id +
        "-" +
        code +
        "'><i class='fas fa-chevron-circle-right color-orange fa-2x'></i> " +
    ...
    jQuery(".td-content-modal-" + week_id).append(
      "<div class='d-flex align-items-center form-group mb-1 content-" +
        week_id +
        "-" +
        code +
        "'><a href='javascript::void(0);' class='color-orange font20 mr-1' onclick=\"removeInput('content-" +
        week_id +
        "-" +
        code +
        "')\"><i class='fas fa-minus-circle fas-16'></i></a><input type='text' value='" +
...
jQuery(function () {
  ...
  //     jQuery(".wrap-modal-learning-content-week-" + week_id).append(
  //       "<div class='pl-25 mb-2 font14 wrap-fontawesome content-learning-" +
  //         week_id +
  //         "-" +
  //         btn +
  //         "'><a href='javascript::void(0);' class='color-orange font20 mr-1 ml--25' onclick=\"removeInput('content-learning-" +
  //         week_id +
  //         "-" +
  //         btn +
  //         "')\"><i class='fas fa-minus-circle fas-16'></i></a> " +
  //         content +
  //         "</div>"
  //     );

  //     jQuery(".wrap-learning-content-week-" + week_id).append(
  //       "<div class='pl-25 mb-2 font14 wrap-fontawesome content-learning-" +
  //         week_id +
  //         "-" +
  //         btn +
  //         "'><i class='fas fa-chevron-circle-right color-orange fa-2x ml--25'></i> " +
  //         content +
  //         "</div>"
  //     );
  //   });
  ...
  //     jQuery(".wrap-modal-activity-content-week-" + week_id).append(
  //       "<div class='pl-25 mb-2 font14 wrap-fontawesome content-learning-" +
  //         week_id +
  //         "-" +
  //         btn +
  ...
  jQuery(".btn-content-week").click(function () {
    ...
    jQuery(".wrap-modal-content-box-week-" + week_id).append(
      "<div class='pl-25 mb-2 font14 wrap-fontawesome content-learning-" +
        week_id +
        "-" +
        btn +
  ...
  jQuery("#email-toltip .toltip-content p").text(function (index, currentText) {
    if (currentText.length > 140) return currentText.substr(0, 140) + "...";
  ...
  jQuery("#save-week-1, #complete-week-1").click(function () {
    jQuery("#w1-co").html(
      "Connect with a partner in another country and engage in conversations that result in a joint project that enhances student's intercultural competency skills and knowledge."
    );
    jQuery("#w1-led").html(
      "• Synchronous Video Lecture<br>• Independent Assignments"
    );
    jQuery("#w1-a").html("• Syllabus Review");
    jQuery("#w1-c").html(
      "• Text Book: Global Ethics, Chapter 1<br>• Video: Introduction to COIL"
    );
  ...
  jQuery("#notification-toltip .toltip-item a.close-times").click(function () {
    ...
    var notification_number_outer_current = jQuery(
      ".top-wrap-notifications .outer"
    ).html();
    notification_number_outer_current = parseInt(
      notification_number_outer_current
    );
    notification_number_outer_new = notification_number_outer_current - 1;
    jQuery(".top-wrap-notifications .outer").html(
      notification_number_outer_new
    );
  ...
  jQuery("#my-calendar-container").on(
    "mouseleave",
    ".event-styled .popup",
    function () {
  ...
  $("#badgesModal, #notificationModal, #messagesModal").on(
    "hide.bs.modal",
    function () {
      jQuery(".note").show();
    }
...
function project_type(values) {
  ...
  switch (values) {
    ...
    case "Peer Review":
    case "Research":
      jQuery("#wrap-project-type").html(htmlcont_1);
      break;

    case "Course Development":
      jQuery("#wrap-project-type").html(htmlcont_2);
      break;

    case "Curriculum Development":
      jQuery("#wrap-project-type").html(htmlcont_3);
      break;

    case "Study Abroad":
    case "Other":
      jQuery("#wrap-project-type").html(htmlcont_4);
      break;
  }
}
...
function discipline_1(option) {
  if (option != "") jQuery("#select_discipline_2").removeAttr("disabled");
  else {
...
function discipline_2(option) {
  if (option != "") jQuery("#select_discipline_3").removeAttr("disabled");
  else {
