export const administratorGordon = {
  ...
  calendar: {
    // month and year should be deprecated because calendar should show current month and year.
    month: "01",
    year: "2021",
    colorKeys: [
      {
    ...
    // calendar data is pulled from Moodle server in ShowMyCalendar component
    data: [
