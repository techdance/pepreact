const initialState = {
  ...
  userInfo: {},
  languageList: null,
  profile: { percentage: 0 ,personalInformation: null, institutionProfile: null,CollaboratedUserProfileimage:null, communicationPreferences: null, credentials: null, professionalBio: null, areaofinterest_list: null },
}
...
const OrganizationReducer = (state = initialState, action) => {
  switch (action.type) {
    case "GET_DATA":
      ...
      case "GET_PROFILE_PERCENTAGE_DETAILS":
      return {
        ...state,
        profile: Object.assign(state.profile,{ percentage: action?.data?.percentage }),
      }
      ...
      return {
        ...state,
        profile: Object.assign(state.profile ,{ CollaboratedUserProfileimage: action?.data?.CollaboratedUserProfileimage }),
      }
    ...
    case "GET_COLLABORATED_PROFILE_AREA_OF_INTEREST_ALL":
        return {
          ...state,
          profile: Object.assign(state.profile, {areaofinterest_list: action.data.CollaboratedProfileAreaofInterest}),
        }
    ...
    case "GET_LANGUAGE_LIST":
        return {
          ...state,
          languageList: action?.data?.language_array,
        }
