...
function App() {
  ...
  console.log(' locationPathName: ', window.location.pathname);
        ...
        <div>
          <Switch>
              ...
              <Route exact path="/profile">
                  <InspiredPage
                      render={(profile, IT) => (
                          <ViewProfileContainer profile={inezProfessor} IT="false" Loader={Loader}/>
                      )}
            ...
            /> */}
              ...
              <Route exact path="/edit-profile">
                  <InspiredPage
                      render={(profile, IT) => (
                          <EditProfileContainer profile={pamelaIT} IT="false" />
                      )}
          ...
          <div class="row mb-2 mt-5">
                <div class="col-md-12 text-center">© Tower Education Technologies | <a href="javascript:void(0);" data-toggle="modal" data-target="#termsModal">Terms of Service</a> | <a href="javascript:void(0);" data-toggle="modal" data-target="#privacyModal">Privacy Policy</a> | <a href="#">Help</a> | <a href="#">Contact Us</a>
                </div>
            </div>
            <img src={registerImg} className="block" />
          </footer>
        </div>
    </Router>
  );
