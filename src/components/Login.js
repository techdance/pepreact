...
function Login() {
  ...
  function getUrlVars() {
    var vars = {};
    // TLM: parts not used in code as of 07/08/2020 but appears to be intent so leaving in place.
  ...
  function loginAction(e) {
    e.preventDefault();
    // TLM: allowSbmit not used in code as of 07/08/2020 but appears to be intent so leaving in place.
    let allowSbmit = true;

    //  TLM: Making hard "equal" rather than soft
    if (userName === "") {
      allowSbmit = false;
    }
    if (password === "") {
  ...
  //   TLM: url not used in code as of 07/08/2020
