      ...
      <>
        ...
        { ( !image && !selectedImage ) && ( <Loader
          ...
          {this.state.selectedImage ? (
            <img
              src={selectedImage} // this should be the this.state.selectedImage but I'm not saving in onFileChange()
              alt=""
              className="img-responsive"
               alt="" 
            ></img>
          ) : (
            <img src={image} alt="" className="img-responsive"  alt="" ></img>
          )}
        </label>
        <input
          id="image-upload"
