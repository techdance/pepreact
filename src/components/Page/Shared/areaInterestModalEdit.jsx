...
import { reducer } from "./usefulFunctions";
import SimpleSelect from "./UI/SimpleSelect";
import CalendarSelector from "./UI/CalendarSelector";
import ModalPortal from "./UI/ModalPortal";
import MessageModal from "./UI/MessageModal";

// Keeping below code commented for now because I don't know which modal format we are keeping (3 disciplines/4 regions vs 1 discipline/1 region and other fields)
...
export default function AreaInterestModalEdit(props) {
