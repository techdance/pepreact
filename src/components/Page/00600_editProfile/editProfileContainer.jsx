...
import { getProfessor } from "../../../repositories/ProfessorRepository";
...
class EditProfileContainer extends React.Component {
  constructor(props) {
    ...
    // old way is to pass profile and IT flag via props, new way is to pass via the URL - need to support both until remove all old ways
    if (this.props.profile !== undefined) {
      this.state = this.props.profile;
      this.IT = this.props.IT;
    } else {
      const url = new URL(document.location.href);
      const professorId = url.searchParams.get("professorId");
      let profile = getProfessor(professorId);
      this.state = profile;
      this.IT = url.searchParams.get("IT");
    }
