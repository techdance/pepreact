        ...
        <div className="inner-wrap">
          <div className="box-top position-relative">
            <h2 className="box-subhead">
              <span className="icon-solid icon-sun-haze"></span>Opportunities
            </h2>
          ...
          <div className="d-flex ml-2">
            <div>
              <div className="item-link">
                <a href="#0">
                  <i className="fas fa-circle color-blue-light mr-1"></i> Campus
                  Jobs
                </a>
              </div>
              <div className="item-link">
                <a href="#0">
                  <i className="fas fa-circle color-yellow mr-1"></i> Virtual
                  Exchange Programs
                </a>
              </div>
              <div className="item-link">
                <a href="#0">
                  <i className="fas fa-circle color-green mr-1"></i> Internships
                  and Externships
                </a>
              </div>
            </div>
