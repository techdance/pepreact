...
function Register(props) {
  ...
  // TLM: firstNameError is not used as of 07/08/2020 but left code in place as it appears to needed in future for better UX
  const [firstNameError, setFirstNameError] = useState(false);
  const [showFirstNameError, setShowFirstNameError] = useState(false);

  const [lastName, setLastName] = useState("");
  // TLM: lastNameError is not used as of 07/08/2020 but left code in place as it appears to needed in future for better UX
  ...
  // TLM: variable is not used as of 07/08/2020
  ...
  function shoot(e) {
    ...
    // TLM: Make hard equal rather than soft
    if (firstName === "") {
    ...
    if (allowSbmit && !confirmPasswordError) {
      ...
      axios
        .post("http://23.99.141.44:3000/registerUser", formData, config)
        .then((response) => {
  ...
  function changeConfirmPassword(val) {
    ...
    // TLM: Make hard not equal rather than soft
  ...
  return (
    <div id="container">
      <header id="wrap-logo" className="ac">
        {/* TLM: href anchor not valid as of 07/08/2020 but appears to be the intent so leaving in place. */}
        <a href="#">
          <img src={logo} />
        </a>
      </header>
        ...
        <form>
          ...
          <div class="wrap-input icon-user">
            ...
            <Textbox
              ...
              validationCallback={(res) =>
                setLastNameError({ lastNameError: res, validate: false })
              }
          ...
          <div class="wrap-input icon-envelope">
            ...
            <Textbox
              ...
              validationCallback={(res) =>
                setEmailError({ emailError: res, validate: false })
              }
          ...
          <div class="wrap-input icon-shield">
            <Textbox
              ...
              validationCallback={(res) =>
                setInstNameError({ instNameError: res, validate: false })
              }
          ...
          <div class="wrap-input icon-lock">
            <Textbox
              ...
              validationCallback={(res) =>
                setPasswordError({ passwordError: res, validate: false })
              }
            ...
            />
            <span
              class="icon-eye fa fa-fw field-icon toggle-password fa-eye"
              aria-hidden="true"
              onClick={(event) => {
          ...
          <div class="wrap-input icon-lock">
            ...
            <Textbox
              ...
              onBlur={(val, e) => {
                //   TLM: Change to hard not equal rather than soft.
              ...
              validationOption={{
                ...
                customFunc: (confirmPassword) => {
                  //Optional.[Func].Default: none. Custom function. Returns true or err message or { error: true, message: 'message', showOnSuccess: true }
