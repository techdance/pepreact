...
class EditProfileContainer extends React.Component {
  constructor(props) {
    ...
    this.props.collaboratedUserProfileimageSave({ params: { token: AuthService.getToken() }, dataObj: null })
  }
  ...
  axios.all([thoughtSave, communicationPreferencesSave,,collaboratedUserProfileimageSave,collaboratedUsercredential,
