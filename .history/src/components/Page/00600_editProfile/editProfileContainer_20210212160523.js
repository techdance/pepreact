...
class EditProfileContainer extends React.Component {
 ...
 // this.props.getCollaboratedUserProfileimage({ params: { token: AuthService.getToken() }, dataObj: null });
  ...
  handleSubmit = (event) => {
    ...
    // let areaofexpertiseObj =  ['1','2','3']?.map( (data, index) => ({ ['areaOfExpertise'+index]  })).reduce((a,b)=>(Object.assign(a, b)))
    let collaborateduserprofessionalbioSaveObj = Object.assign({
      ...
      'areaOfExpertise3': areaOfExpertise.areaOfExpertise3
     }, areaofexpertiseObj)
    ...
    let thoughtSaveObj = {
      token,
      "thought": personalInformation.thoughts, 
      "onlinestatus":1
    }
