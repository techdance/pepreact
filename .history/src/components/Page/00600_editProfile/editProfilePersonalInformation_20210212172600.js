...
class EditProfilePersonalInformation extends React.Component {
  ...
  render() {
    const {
      ...
      department,
      onlineStatus,
      CollaboratedUserProfileimage
    } = this.state;

 
    const imageSrc = 'data:image/png;base64,'+ CollaboratedUserProfileimage?.blobData;
    const disable = {
      "pointer-events": "none",
      "color": "#ccc"
    };
    console.log(' from imageSrc: ',  CollaboratedUserProfileimage);
                ...
                <div className="row row-custom">
                  <div className="col-md-6">
                    <div className="bg-profile no-bg">
                      <ChangeImage image={imageSrc}  />
                      {/* <img src={imageSrc}  width="141" alt=""  /> */}
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className="form-group">
