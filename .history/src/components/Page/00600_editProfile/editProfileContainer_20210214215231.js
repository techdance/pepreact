...
import { getUserData,
  ...
  getCommunicationPreferences, getCollaborateduserprofessionalbio, 
  getCollaboratedProfileAreaofInterestAll, 
  getCollaboratedUsercredential } from "../../../redux/actions/users"
...
class EditProfileContainer extends React.Component {
  constructor(props) {
    super(props);
    this.state =  this.props.app.profile;
  ...
  componentDidMount(){
    ...
    console.log(' from componnetDidMount: ', this.props);

    let paramsToken = { token: AuthService.getToken() };
    console.log(' token params: ', paramsToken);
    this.props.getCollaboratedUserProfileimage(paramsToken);
 ...
 reflashImage = () => {
  ...
  axios.all([thoughtSave, communicationPreferencesSave,collaboratedUsercredential,
    ...
    if(responseZero.data.status){
      ...
      toast.success(responseZero.message);
    }
  ...
  render() {
    ...
    console.log(' CollaboratedUserProfileimage: ', CollaboratedUserProfileimage, this.props);
    return (
      <>
          ...
          <form onSubmit={this.handleSubmit}>
            <div className="row row-custom ">
              <EditProfilePersonalInformation
                ...
                collaboratedUserProfileimage={CollaboratedUserProfileimage}
                reflashImage={this.reflashImage}
