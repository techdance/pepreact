...
class ShowCredentials extends React.Component {
  render() {
    ...
    let { membership =  null , certificate = null } = this.props?.credentials;
            ...
            <div className="inner-wrap">
              ...
              <div className="box-middle">
                ...
                <div className="content-icon">
                  ...
                  { membership && Object.keys(membership)?.map(
                    (PMembershipKey, index) => (
                      <p className="blue-color pl-4" key={index}>
                        <a href={membership[PMembershipKey]}>
                          {membership[PMembershipKey]}
                        </a>
                      </p>
                    )
                  )}
