...
import { getUserData, getPersonalInformation,
  ...
  getCommunicationPreferences, getCollaborateduserprofessionalbio, getCollaboratedProfileAreaofInterestAll, getCollaboratedUserProfileimage } from "../../../redux/actions/users"
...
class ViewProfileContainer extends React.Component {
  ...
  render() {
    ...
    console.log(' profile: ', profile.personalInformation);
